...
class OWSplitUpload(OWBwBWidget):
    ...
    docker_image_tag = "277.0.0-alpine_3.11.3__647bb0db"
    inputs = [("Trigger",str,"handleInputsTrigger"),("credentials_file",str,"handleInputscredentials_file"),("bucket",str,"handleInputsbucket"),("cloud_dir",str,"handleInputscloud_dir"),("outputdir",str,"handleInputsoutputdir"),("barcode",str,"handleInputsbarcode")]
