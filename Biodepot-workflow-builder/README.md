...
A 7 minute Youtube video is available: [https://youtu.be/WHb_lQv3Y8Y](https://youtu.be/WHb_lQv3Y8Y) 


#### Get AWS credentials

Before going further, you need to obtain a set of credentials for your AWS account. Instructions are in the top-level README as to how to obtain your access_key_id and your secret_access_key

You then need to create a credentials directory
...
On Linux machines, <ip\> will be localhost or 127.0.0.1
...
## Instructions for GCP workflow


#### Install Docker and start Bwb-umi

Follow the same instructions as for the AWS workflow

#### Load workflow

Under the File menu choose Load workflow and navigate to /workflows

Click on GCP-workflow-UMI and click on the choose button
...
Create a project and obtain a credentials json file as described in the top-level README file
